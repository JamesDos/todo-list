...
const DisplayController = (() => {
  ...
  const switchHomeTab = item => {
    ...
    if (item.textContent === 'All Tasks') {
      allProjects.forEach(project =>  _display_functions__WEBPACK_IMPORTED_MODULE_3__.DisplayFunctions.displayTodoList(project.todoElmList));
